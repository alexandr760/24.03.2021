...
# Функция, которая отдает кнопки с Названием и ..., по выбранной категории и подкатегории
...
async def navigate(call: CallbackQuery, callback_data: dict):
    ...
    # Получаем айди, который выбрал пользователь (Передается НЕ ВСЕГДА - может быть 0)
    ...
    levels = {
        ...
        "2": list_items,  # Отдаем желаемое
        "3": show_item  # Предлагаем перейти
    }
